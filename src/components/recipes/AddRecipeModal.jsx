...
export default function AddRecipeModal({ onClose, onAdd }) {
  ...
  const [ingredients, setIngredients] = useState([{ name: '', quantity: '', unit: 'piece' }])
  const [equipment, setEquipment] = useState([''])
  const [steps, setSteps] = useState([{ instruction: '', duration_minutes: '' }])
    ...
    <div className="fixed inset-0 z-[70] flex items-end md:items-center justify-center">
      ...
      <div className="relative bg-white w-full md:max-w-lg md:rounded-2xl rounded-t-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
          <h2 className="font-semibold text-gray-900">{t('recipes.addRecipe')}</h2>
