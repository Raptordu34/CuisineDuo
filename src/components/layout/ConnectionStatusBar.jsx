...
export default function ConnectionStatusBar() {
  ...
  const allOk = isOnline && isSupabaseReachable && isApiReachable

  // Ne rien afficher si tout est ok et pas de banniere a montrer
  if (allOk && !showRestored) return null
  ...
  return (
    <>
      ...
      {/* Indicateur visible seulement si probleme */}
      {!allOk && !showRestored && (
        <>
